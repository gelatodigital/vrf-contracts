...
/// This base contract enhances the GelatoVRFConsumer by introducing request IDs and ensuring unique random values 
...
abstract contract GelatoVRFConsumerBase is GelatoVRFConsumer {
    ...
    /// @dev The function ensures that only the correct entity (operator) can fulfill the randomness request.
